...
const useScroll = () => {
  ...
  const getOverlayClassNames = () => {
    return clsx(
      "fixed inset-0 -z-10 bg-[#e5e5e5] transition-opacity duration-300 rounded-image",
      {
  ...
  const getImageClassNames = () => {
    return clsx("absolute w-full rounded-image", {
            ...
            <div>
              <div className="flex flex-col items-start justify-center md:h-screen">
                ...
                <h2 className="heading-h2 mb-5 font-bold md:mb-6">
                  Essential student resources at your fingertips
                </h2>
                <p className="text-medium">
                  Access critical online platforms that support your academic
                  journey and personal growth.
                </p>
                <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                  <Button title="Access" variant="secondary">
                    Access
                  </Button>
                  <Button
                    title="Explore"
