          ...
          <div className="mb-12 md:mb-18 lg:mb-20">
            <div className="mx-auto flex max-w-lg flex-col items-center text-center">
              ...
              <p className="text-medium mb-5 md:mb-6">
                Our commitment to sustainability goes beyond campus boundaries.
                We integrate environmental consciousness into every aspect of
                our academic and operational practices.
              </p>
