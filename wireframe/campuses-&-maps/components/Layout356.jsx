                  ...
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <h2 className="heading-h2 mb-5 font-bold md:mb-6">
                        Our campus network across Lebanon
                      </h2>
                      <p className="text-medium">
                        Global University spans four strategic locations, each
                        designed to provide unique learning environments. Our
                        campuses connect students with opportunities across
                        Lebanon.
                      </p>
