        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h1 className="heading-h2 mb-5 font-bold md:mb-6">
              Your academic path awaits
            </h1>
            <p className="text-medium">
              Browse our comprehensive selection of programs across multiple
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Humanities</p>
                <h2 className="heading-h3 mb-5 font-bold md:mb-6">
                  Discover literature and humanities programs
                </h2>
                <p>
                  Explore creative and analytical approaches to understanding
                  human culture and expression.
                </p>
                <div className="mt-6 flex items-center gap-x-4 md:mt-8">
                  <Button title="View programs" variant="secondary">
                    View programs
                  </Button>
                  <Button
                    title="Details"
