      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            <p className="mb-3 font-semibold md:mb-4">Academic</p>
            <h1 className="heading-h2 mb-5 font-bold md:mb-6">
              Faculties that inspire change
            </h1>
            <p className="text-medium">
              Global University offers comprehensive academic programs designed
              to challenge and empower students across multiple disciplines. Our
              faculties represent the core of our intellectual pursuit.
            </p>
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Literature</p>
                <h2 className="heading-h3 mb-5 font-bold md:mb-6">
                  Faculty of literature and humanities
                </h2>
                <p>
                  Explore the power of human expression through critical
                  analysis and creative thinking. Our literature program
                  cultivates deep understanding of cultural narratives.
                </p>
