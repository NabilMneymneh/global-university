      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="heading-h2 mb-5 font-bold md:mb-6">
            Depth of literary studies
          </h1>
          <p className="text-medium">
            Uncover the profound narratives that shape human understanding
          </p>
        </div>
            ...
            <div className="block p-6 sm:flex sm:flex-col sm:justify-center md:p-8">
              <div>
                ...
                <h2 className="heading-h4 mb-3 font-bold md:mb-4">
                  Languages that connect global perspectives
                </h2>
                <p>Discover languages that bridge cultures and ideas</p>
              </div>
          ...
          <Card className="flex flex-col">
            <div className="flex flex-1 flex-col justify-center p-6 md:p-8">
              <div>
                ...
                <p>Analyze texts across cultural and historical boundaries</p>
              </div>
              <div className="mt-5 md:mt-6">
                <Button
                  title="Explore"
