        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="text-medium">
              Global University represents academic excellence and growth in
              Lebanon. Our commitment to education transforms lives and
              communities.
            </p>
          ...
          >
            <Card className="grid grid-cols-1 md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Students</p>
                <h2 className="heading-h3 mb-5 font-bold md:mb-6">
                  Diverse and dynamic student body
                </h2>
                <p>
                  Our student population represents multiple backgrounds and
                  regions. We support over 3,000 students across undergraduate
