        ...
        <section className="py-16">
          <Container>
            <div className="prose prose-lg max-w-none">
              ...
              <StaggerContainer className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-2">
                <FadeIn delay={0.1}>
                  <div className="h-full rounded-3xl border border-border bg-background p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
